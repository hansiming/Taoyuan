...
public class UserInfo {
	...
	/**   
	 * @Fields gradeId : The gradeId of UserInfo
	 */ 
	private int gradeId;
	...
	/**   
	 * @Fields professionId : The professionId of UserInfo
	 */ 
	private int professionId;
	
	/**   
	 * @Fields roomFloorId : The roomFloorId of UserInfo
	 */ 
	...
	public int getRoomFloorId() {
		return roomFloorId;
	}
	
	public void setRoomFloorId(int roomFloorId) {
	...
	public String toString() {
		return "UserInfo [id=" + id + ", headImage=" + headImage + ", gender=" + gender + ", realName=" + realName
				+ ", telePhone=" + telePhone + ", gradeId=" + gradeId + ", userId=" + userId
				+ ", professionId=" + professionId + ", roomFloorId=" + roomFloorId + "]";
	}
}
